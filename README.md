...
Windows 桌面照片管理应用 —— 快速识别并清理重复/相似照片，智能批量重命名，修复照片方向问题，制作标准尺寸证件照。
...
- 支持 12 种热门证件照尺寸（1寸、2寸、小1寸、小2寸、大1寸、大2寸、护照、美国签证、申根签证、日本签证、驾驶证、社保卡）
- 每个尺寸显示详细的打印尺寸（mm）、像素大小、分辨率（DPI）
- Canvas 交互式裁剪，支持拖动和缩放，锁定目标宽高比
- 三分线辅助构图
- 背景颜色选择（白色、蓝色、红色、保持原背景）
- 输出格式可选 JPEG/PNG，质量可调（50-100）
- 自动嵌入 DPI 元数据，适配打印需求
