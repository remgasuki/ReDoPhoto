...
**项目基础文档**：
项目包含完整的 README.md 文档，提供了项目概述、功能特性、技术栈介绍和快速上手指南。建议在开始安装前先阅读 README.md 以了解项目背景和使用方法。
...
```bash
# 使用 HTTPS
git clone https://github.com/remgasuki/redophoto.git

# 或使用 SSH
git clone git@github.com:remgasuki/redophoto.git
```
